...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnRegister,
      ...
      @NonNull ImageView ivLogo, @NonNull LinearLayout llBottom, @NonNull LinearLayout llForm,
      @NonNull LinearLayout llLogo, @NonNull ProgressBar progressBar,
      ...
      @NonNull TextView tvEmailLabel, @NonNull TextView tvError, @NonNull TextView tvLoginLink,
      @NonNull TextView tvPasswordLabel, @NonNull TextView tvSubtitle,
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((ConstraintLayout) rootView, btnRegister,
          etConfirmPassword, etEmail, etPassword, etUsername, ivLogo, llBottom, llForm, llLogo,
          progressBar, tilConfirmPassword, tilEmail, tilPassword, tilUsername, tvAppName,
          tvConfirmPasswordLabel, tvEmailLabel, tvError, tvLoginLink, tvPasswordLabel, tvSubtitle,
          tvUsernameLabel);
    }
